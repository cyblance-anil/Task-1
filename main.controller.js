var mymodal = angular.module('exampleApp', ['spotify', 'ngDialog']);

  mymodal.config(function (SpotifyProvider) {
  ...
  mymodal.controller('MainController', ['$scope', 'Spotify', 'ngDialog', function ($scope, Spotify, ngDialog) {
